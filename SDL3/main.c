...
// // Global pointers to the window and renderer
// static SDL_Window *window = NULL;
// static SDL_Renderer *renderer = NULL;

// // Called once at startup
// SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[]) {
//     SDL_SetAppMetadata("SDL3 Example", "1.0", "com.example.sdl3demo");
...
//     if (SDL_CreateWindowAndRenderer("SDL3 Window", 640, 480, 0, &window,
//     &renderer) < 0) {
...
// // Called when an event (key, mouse, quit) is received
// SDL_AppResult SDL_AppEvent(void *appstate, SDL_Event *event) {
//     if (event->type == SDL_EVENT_QUIT) {
//         return SDL_APP_SUCCESS; // Quit the app
//     }
//     return SDL_APP_CONTINUE;
// }
...
//     // Window and renderer are cleaned up by SDL
